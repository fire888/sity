...
function toggleTheme(){
  ...
  if($('.top-safe-area img').attr('src') == 'desktop/status-bar.svg'){
    $('.top-safe-area img').attr('src', 'desktop/status-bar-white.svg')
  }
  else {
    $('.top-safe-area img').attr('src', 'desktop/status-bar.svg')
  }
}
